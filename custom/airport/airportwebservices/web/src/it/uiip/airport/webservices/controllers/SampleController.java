 ...
 */
package it.uiip.airport.webservices.controllers;

import static it.uiip.airport.webservices.constants.AirportwebservicesConstants.CLIENT_CREDENTIAL_AUTHORIZATION_NAME;
import static it.uiip.airport.webservices.constants.AirportwebservicesConstants.PASSWORD_AUTHORIZATION_NAME;
...
import it.uiip.airport.webservices.data.UserData;
import it.uiip.airport.webservices.data.UserDataList;
import it.uiip.airport.webservices.dto.SampleWsDTO;
import it.uiip.airport.webservices.dto.TestMapWsDTO;
import it.uiip.airport.webservices.dto.UserWsDTO;
import it.uiip.airport.webservices.dto.UsersListWsDTO;
import it.uiip.airport.webservices.dto.UsersPageWsDTO;
import it.uiip.airport.webservices.facades.SampleFacades;
...
public class SampleController
{
	 ...
	 * Example :</br>
	 * GET http://localhost:9001/airportwebservices/sample/dto/sampleValue
	 *
	 * @param pathVariable
	 ...
	 * Example :</br>
	 * URL : http://localhost:9001/airportwebservices/sample/dto</br>
	 * Method : POST</br>
	 ...
	 * <ul>
	 * <li>http://localhost:9001/airportwebservices/sample/users
	 * <li>http://localhost:9001/airportwebservices/sample/users?fields=users(info)
	 * <li>http://localhost:9001/airportwebservices/sample/users?fields=users(BASIC)
	 * <li>http://localhost:9001/airportwebservices/sample/users?fields=users(DEFAULT)
	 * <li>http://localhost:9001/airportwebservices/sample/users?fields=users(FULL)
	 * <li>http://localhost:9001/airportwebservices/sample/users?fields=users(firstName,addresses(street))
	 * </ul>
	 */
	 ...
	 * <ul>
	 * <li>http://localhost:9001/airportwebservices/sample/usersPaged
	 * <li>http://localhost:9001/airportwebservices/sample/usersPaged?currentPage=1
	 * <li>http://localhost:9001/airportwebservices/sample/usersPaged?currentPage=0?pageSize=1
	 * </ul>
	 */
	 ...
	 * <ul>
	 * <li>http://localhost:9001/airportwebservices/sample/users/user1
	 * <li>http://localhost:9001/airportwebservices/sample/users/user1?fields=info
	 * <li>http://localhost:9001/airportwebservices/sample/users/user1?fields=BASIC
	 * <li>http://localhost:9001/airportwebservices/sample/users/user1?fields=DEFAULT
	 * <li>http://localhost:9001/airportwebservices/sample/users/user1?fields=FULL
	 * <li>http://localhost:9001/airportwebservices/sample/users/user1?fields=firstName,addresses(street)
	 * </ul>
	 */
	 ...
	 *
	 * Url: http://localhost:9001/airportwebservices/sample/map
	 *
	 */
