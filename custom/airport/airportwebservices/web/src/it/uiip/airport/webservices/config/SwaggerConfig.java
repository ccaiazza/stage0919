 ...
 */
package it.uiip.airport.webservices.config;

import static it.uiip.airport.webservices.constants.AirportwebservicesConstants.API_VERSION;
import static it.uiip.airport.webservices.constants.AirportwebservicesConstants.AUTHORIZATION_SCOPE_PROPERTY;
import static it.uiip.airport.webservices.constants.AirportwebservicesConstants.AUTHORIZATION_URL;
import static it.uiip.airport.webservices.constants.AirportwebservicesConstants.CLIENT_CREDENTIAL_AUTHORIZATION_NAME;
import static it.uiip.airport.webservices.constants.AirportwebservicesConstants.DOCUMENTATION_DESC_PROPERTY;
import static it.uiip.airport.webservices.constants.AirportwebservicesConstants.DOCUMENTATION_TITLE_PROPERTY;
import static it.uiip.airport.webservices.constants.AirportwebservicesConstants.LICENSE_PROPERTY;
import static it.uiip.airport.webservices.constants.AirportwebservicesConstants.LICENSE_URL_PROPERTY;
import static it.uiip.airport.webservices.constants.AirportwebservicesConstants.PASSWORD_AUTHORIZATION_NAME;
import static it.uiip.airport.webservices.constants.AirportwebservicesConstants.TERMS_OF_SERVICE_URL_PROPERTY;
